...
<svelte:head>
	<title>Sign Up — Selfie</title>
</svelte:head>

<div class="text-center mb-8">
	<h1 class="font-['Cormorant_Garamond'] text-4xl font-bold text-[#F0EBE1]">Create Account</h1>
	<p class="mt-2 text-[#F0EBE1]/60">Start creating AI portraits of yourself</p>
</div>
...
<div class="mt-6 text-center text-sm text-[#F0EBE1]/60">
	...
	<a href="/auth/login" class="text-[#D4A853] hover:underline">Log in</a>
</div>
...
<div class="mt-4">
	...
	<form method="GET" action="/auth/login?provider=google" class="mt-4">
		<button
			type="submit"
